...
| `docs/store/store-screenshot-3-how-to-use-1280x800.png` | Chrome Web Store screenshot showing a four-step usage workflow | No | Yes | Project-owned HTML/CSS rendered to PNG with Chrome headless | Hoang Tat / project owner | Project-owned promotional asset | Generated from `docs/store/store-screenshot-3-how-to-use-1280x800.html`; visual inspection found synthetic extension UI only, no third-party logo, no personal data | Codex-generated project asset under user direction | Low | APPROVED FOR STORE USE |
| `docs/store/store-screenshot-3-how-to-use-1280x800.html` | Editable source for how-to-use screenshot | No | No | Project-owned HTML/CSS source | Hoang Tat / project owner | Project-owned promotional asset | Source file for approved PNG; references only local project icon and synthetic UI | Codex-generated project asset under user direction | Low | APPROVED AS SOURCE ASSET |
